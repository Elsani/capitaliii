                    ...
                    <div class="row">
                        <div class="col-12 offset-md-1 col-md-10 offset-lg-2 col-lg-8 pl0 pr0">
                            <div class="text_started text_sign">
                                <h3>Enter E-mail to reset your password</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 offset-md-1 col-md-10 offset-lg-2 col-lg-8 pl0 pr0">
                            <div class="text_formstarted text_formlogin">
                                <form class="parsleyform">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label> E-mail </label>
                                            <input data-required="true" data-type="email" name="E-mail" id="email" />
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="fontpass">
                                         ...
                                         <div class="col-xs-12 col-md-12 btn_confirm mt20">
                                            <router-link to="/write_us">Send New password</router-link>
                                        </div>
                                     </div>
                                </form>        
                            </div>
